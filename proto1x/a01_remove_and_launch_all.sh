...
tmux send-keys -t "${SESSION}:0.0" '. ~/workspace/banpaku_scripts/proto1x/start_sensors.sh' C-m
...
tmux send-keys -t "${SESSION}:0.2" '. ~/workspace/banpaku_scripts/proto1x/set_exposure_and_remove_docker_container.sh' C-m
...
tmux send-keys -t "${SESSION}:0.2" ". ~/workspace/banpaku_scripts/proto1x/docker_run_local_discovery_server.sh" C-m
...
tmux send-keys -t "${SESSION}:0.4" '. ~/workspace/banpaku_scripts/proto1x/docker_run_remote_discovery_server.sh' C-m
