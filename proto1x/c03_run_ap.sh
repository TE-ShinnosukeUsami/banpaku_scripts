...
tmux send-keys -t "${SESSION}:0.0" '. ~/workspace/banpaku_scripts/proto1x/docker_run_ap.sh' C-m
...
tmux send-keys -t "${SESSION}:0.1" '. ~/workspace/banpaku_scripts/proto1x/docker_setup_commander.sh' C-m
sleep 1
...
tmux send-keys -t "${SESSION}:0.2" '. ~/workspace/banpaku_scripts/proto1x/docker_setup_commander.sh' C-m
