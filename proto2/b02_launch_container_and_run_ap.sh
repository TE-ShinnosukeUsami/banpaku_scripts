...
tmux send-keys -t "${SESSION}:0.2" '. ~/workspace/banpaku_scripts/proto2/docker_run_remote_discovery_server.sh' C-m
...
tmux send-keys -t "${SESSION}:0.4" '. ~/workspace/banpaku_scripts/proto2/docker_setup_commander.sh' C-m
