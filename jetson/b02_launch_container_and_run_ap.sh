...
tmux send-keys -t "${SESSION}:0.0" '. ~/workspace/banpaku_scripts/jetson/run_docker.sh' C-m
sleep 1
...
tmux send-keys -t "${SESSION}:0.0" ". ~/workspace/banpaku_scripts/jetson/docker_run_local_discovery_server.sh" C-m
...
tmux send-keys -t "${SESSION}:0.2" '. ~/workspace/banpaku_scripts/jetson/docker_run_remote_discovery_server.sh' C-m
...
tmux send-keys -t "${SESSION}:0.4" '. ~/workspace/banpaku_scripts/jetson/docker_setup_commander.sh' C-m
